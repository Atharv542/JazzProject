 ...
 const handleSubmit = async (e) => {
  ...
  {/*if (submitted) {
    return (
      <section
        id="booking"
        className="py-20 bg-gradient-to-br from-emerald-50 via-orange-50 to-rose-50"
      >
          ...
          <div className="max-w-2xl mx-auto text-center">
            <div className="bg-white rounded-2xl p-12 shadow-lg">
              ...
              <p className="text-lg text-gray-600 mb-8">
                Your strategy session request has been received. I'll be in
                touch within 24 hours to confirm your appointment and send you
                the meeting details.
              </p>
              <div className="bg-gradient-to-r from-orange-50 to-rose-50 rounded-lg p-6 border border-orange-200">
        ...
        <div className="text-center mb-12">
          <h2 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-6">
            ...
            <span className="block leading-[1.5] text-transparent bg-clip-text bg-gradient-to-r from-orange-600 to-rose-600">
              Champion Strategy Session
            </span>
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Ready to develop your champion mindset? Let's connect and create
            your winning game plan for success. This is where champions are
            made. No pressure, just pure potential.
          </p>
        </div>
          ...
          >
            ...
            <div className="mt-8 text-center">
              ...
              <p className="text-[12px] md:text-sm text-gray-500 mt-4">
                * This strategy session is completely free with no obligation.
