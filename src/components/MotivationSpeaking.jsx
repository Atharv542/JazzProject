              ...
              return (
                ...
                >
                  <div className={`p-1 rounded-lg ${isActive ? 'bg-white/20' : `bg-${service.color}-100`}`}>
                    <IconComponent className={`w-4 h-4 sm:w-6 sm:h-6 ${isActive ? 'text-white' : `text-${service.color}-600`}`} />
                  </div>
              ...
              <div className="space-y-6 sm:space-y-8">
                <div>
                  <div className="flex items-center space-x-3 sm:space-x-4 mb-4 sm:mb-6">
                    <div className={`p-2 sm:p-3 bg-gradient-to-br from-${speakingServices[activeTab].color}-500 to-${speakingServices[activeTab].accent}-500 rounded-xl sm:rounded-2xl flex-shrink-0`}>
