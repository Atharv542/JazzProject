...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-br from-gray-50 to-emerald-50 border-t border-emerald-100">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8">
          {/* Brand Column */}
          <div className="lg:col-span-1 space-y-6">
            <div className="flex items-center space-x-3">
              <div className="w-10 h-10 bg-gradient-to-br from-emerald-200 to-green-300 rounded-full flex items-center justify-center">
            ...
            <div className="flex space-x-4">
              {socialLinks.map((social) => (
                <a
                  key={social.name}
                  href={social.href}
                  className="w-10 h-10 bg-white rounded-full shadow-md flex items-center justify-center text-gray-600 hover:text-emerald-600 hover:shadow-lg transition-all duration-300"
              ...
              {quickLinks.map((link) => (
                <li key={link.name}>
                  <button
                    ...
                    className="text-gray-600 cursor-pointer hover:text-emerald-600 transition-colors duration-300"
                  >
                    {link.name}
                  </button>
                </li>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                <Phone className="w-5 h-5 -mt-10 text-emerald-600" />
                <div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex items-center space-x-6 text-sm">
              ...
              <button
                ...
                className="bg-gradient-to-r from-emerald-500 to-teal-500 cursor-pointer text-white px-4 py-2 rounded-full text-sm font-medium hover:shadow-lg transform hover:scale-105 transition-all duration-300 flex items-center space-x-1"
              >
